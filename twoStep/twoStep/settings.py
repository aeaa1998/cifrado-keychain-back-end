"""
Django settings for twoStep project.
...
SECRET_KEY = 'loks+fvrz$h3nfms^xwuegams6b$kmsxopm%nm#n06*ni5nd_z'
...
WSGI_APPLICATION = 'twoStep.wsgi.application'
